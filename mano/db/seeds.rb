...
User.create!(first_name: "Joey", last_name: "Chamberlin", email: "joe@joe.com", password: "password", password_confirmation: "password")
User.create!(first_name: "Jeff", last_name: "Keslin", email: "jkeslin@gmail.com", password: "password", password_confirmation: "password")
User.create!(first_name: "Steve", last_name: "Pikelny", email: "spike716@gmail.com", password: "password", password_confirmation: "password")
User.create!(first_name: "Tanner", last_name: "Blumer", email: "blumer.tanner@gmail.com", password: "password", password_confirmation: "password")
...
Transaction.create!(debtor_id: 1, creditor_id: 2, amount: 5, description: Faker::Hacker.say_something_smart, approved: true, closed: false, squaring_event_id: nil, private_trans: false)
Transaction.create!(debtor_id: 3, creditor_id: 2, amount: 10, description: Faker::Hacker.say_something_smart, approved: true, closed: false, squaring_event_id: nil, private_trans: false)
Transaction.create!(debtor_id: 1, creditor_id: 3, amount: 5, description: Faker::Hacker.say_something_smart, approved: true, closed: false, squaring_event_id: nil, private_trans: false)
